function getRndInteger(min, max) {
  ...
  function soru() {
    ...
    Soru = {Number1:Number1, Number2:Number2, islem:secim, cevap:cevap, verilenCevap:"?"};
    ...
    Paragraflar = [
      ...
      [
            ...
            <ul id="SoruGecmisiUl" class="radius">
                ...
                <div id="SoruGecmisiCevap" class="radius"><span id="SoruGecmisiCevap2" class="${soru.verilenCevap === soru.cevap ? "true" : "false"} radius">${soru.verilenCevap === soru.cevap ? "+" + SoruPuanKatsayisi : "+0"}</div></span>
